<?php $__env->startSection('title', 'Tambah Balita'); ?>
    ...
    <div class="dash-wrapper">
        ...
        <div class="dash-main">
            ...
            <div class="dash-content">
                ...
                <form action="<?php echo e(route('balita.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-card-body">
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    <label>NIK</label>
                                    <input type="text" name="nik" placeholder="16 digit NIK" value="<?php echo e(old('nik')); ?>"
                                        required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-card-body">
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="berat_badan" placeholder="0.0"
                                            value="<?php echo e(old('berat_badan')); ?>" required oninput="formatAngka(this)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="tinggi_badan" placeholder="0.0"
                                            value="<?php echo e(old('tinggi_badan')); ?>" required oninput="formatAngka(this)">
                                ...
                                <div class="form-group">
                                    <label>LILA</label>
                                    <div class="input-wrapper">
                                        <input type="text" name="lila" placeholder="0.0" value="<?php echo e(old('lila')); ?>" required
                                ...
                                <div class="form-group">
                                    <label>LIKA</label>
                                    <div class="input-wrapper">
                                        <input type="text" name="lika" placeholder="0.0" value="<?php echo e(old('lika')); ?>" required
                                            oninput="formatAngka(this)">
                                        <span class="input-unit">cm</span>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ITTP\YOI\posyandu - Salin\resources\views/kader/balita/create.blade.php ENDPATH**/ ?>