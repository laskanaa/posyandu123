...
<header class="site-header at-top" id="siteHeader">
    ...
    <div class="nav-container">
        ...
        <a href="<?php echo e(url('/')); ?>#home" class="logo-area">
        ...
        <nav class="nav-menu">
            <a href="<?php echo e(url('/')); ?>#tentang"    class="nav-link">Tentang</a>
            <a href="<?php echo e(url('/')); ?>#informasi"  class="nav-link">Informasi</a>
            <a href="<?php echo e(url('/')); ?>#layanan"    class="nav-link">Layanan</a>
            <a href="<?php echo e(url('/')); ?>#pencegahan" class="nav-link">Pencegahan</a>
            <a href="<?php echo e(url('/')); ?>#galeri"     class="nav-link">Galeri</a>
...
</script><?php /**PATH D:\ITTP\YOI\posyandu - Salin\resources\views/components/header.blade.php ENDPATH**/ ?>