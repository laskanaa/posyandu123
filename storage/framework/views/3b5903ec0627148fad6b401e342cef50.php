...
<section class="hero">
    <div class="hero-slides" id="heroSlides">
        ...
        <div class="hero-slide <?php echo e($key == 0 ? 'active' : ''); ?>">
            <img src="<?php echo e(asset('slider/' . $slider->gambar)); ?>" alt="<?php echo e($slider->judul); ?>">
            <div class="hero-caption">
                <h1><?php echo e($slider->judul); ?></h1>
    ...
    <div class="hero-dots" id="heroDots">
        <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button class="hero-dot <?php echo e($key == 0 ? 'active' : ''); ?>" data-to="<?php echo e($key); ?>" type="button"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</section>
<?php endif; ?>
    ...
    <div class="wrap">
        <div class="tentang-inner">
            <div class="tentang-foto rv left">
                <img src="<?php echo e(asset('tentang/' . $tentang->gambar)); ?>" alt="Tentang Posyandu">
            </div>
            <div class="tentang-teks rv right">
                ...
                <p><?php echo e($tentang->deskripsi1); ?></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="wrap">
        ...
        <div class="stat-grid">
            ...
            <div class="stat-card rv">
                <div class="stat-num">
                    <span class="counter" data-target="<?php echo e($item->angka); ?>">0</span>
                </div>
                <div class="stat-label"><?php echo e($item->judul); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <div class="wrap">
        ...
        <div class="layanan-grid">
            ...
            <div class="layanan-card rv">
                <div class="layanan-icon-wrap"><?php echo $item->icon; ?></div>
...
<section id="pencegahan" class="pencegahan">
    <div class="wrap">
        ...
        <div class="pencegahan-grid">
            <?php $__currentLoopData = $pencegahans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="wrap">
        ...
        <div class="galeri-scroll" id="galeriScroll">
            ...
            <div class="galeri-item">
                <img src="<?php echo e(asset('upload-galeri/' . $item->gambar)); ?>" alt="Galeri">
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ITTP\YOI\posyandu - Salin\resources\views/pages/home.blade.php ENDPATH**/ ?>