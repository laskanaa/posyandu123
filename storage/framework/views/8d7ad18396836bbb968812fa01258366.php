        ...
        <div class="dash-main">
            ...
            <div class="dash-content">
                ...
                <div class="section-header">
                    ...
                    <a href="<?php echo e(route('kader.galeri.create')); ?>" class="btn-add">
                        + Tambah Gambar
                    </a>
                </div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo e(asset('upload-galeri/' . $item->gambar)); ?>" class="img-table">
                                    </td>
                                    <td>
                                        <form action="<?php echo e(route('kader.galeri.destroy', $item->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ITTP\YOI\posyandu - Salin\resources\views/kader/galeri/index.blade.php ENDPATH**/ ?>