<?php $__env->startSection('title', 'Data Informasi'); ?>
        ...
        <div class="dash-main">
            ...
            <header class="dash-topbar">
                <div class="topbar-left">
                    ...
                    <div>
                        <div class="topbar-page">Informasi Posyandu</div>
                        <div class="topbar-sub">Kelola data informasi & statistik</div>
                    </div>
                </div>
                <a href="<?php echo e(route('kader.informasi.create')); ?>" class="btn-add">
                    + Tambah Informasi
                </a>
            </header>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style="width:140px">Angka</th>
                                <th style="width:120px">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $informasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><span class="row-num"><?php echo e($loop->iteration); ?></span></td>
                                    <td>
                                        <div class="judul-tag">
                                            <span class="judul-dot"></span>
                                            <?php echo e($informasi->judul); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <?php if($informasi->angka !== null): ?>
                                            <span class="angka-badge"><?php echo e($informasi->angka); ?></span>
                                        <?php else: ?>
                                            <span class="angka-badge empty">—</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="aksi-cell">
                                            
                                            <a href="<?php echo e(route('kader.informasi.edit', $informasi->id)); ?>" class="btn-edit"
                                                title="Edit">
                                            ...
                                            <form action="<?php echo e(route('kader.informasi.destroy', $informasi->id)); ?>" method="POST"
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="empty-state">
                                            ...
                                            <p>Belum ada data informasi. Tambahkan data pertama Anda.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ITTP\YOI\posyandu - Salin\resources\views/kader/informasi/index.blade.php ENDPATH**/ ?>