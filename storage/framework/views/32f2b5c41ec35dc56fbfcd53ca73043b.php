            ...
            <div class="dash-content">
                ...
                <div class="stat-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($balitas->count()); ?></div>
                    ...
                    <div class="stat-card" style="--c1:#f43f5e;--c2:#fb7185;">
                        ...
                        <div class="stat-value"><?php echo e($stuntingCount); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($balitas->count() - $stuntingCount); ?></div>
                ...
                <div class="table-panel">
                    <div class="table-panel-header">
                        ...
                        <div class="table-actions">
                            <a href="<?php echo e(route('balita.create')); ?>" class="btn-add">
                                <i class="fas fa-plus"></i> Tambah Balita
                            </a>
                            <form method="GET" action="<?php echo e(route('balita.index')); ?>" class="search-form">
                                <input type="text" name="search" placeholder="Cari nama / nama ibu..."
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $balitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $balita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight:600;color:#0d1f1e;"><?php echo e($balita->nama); ?></td>
                                        <td><?php echo e($balita->nik); ?></td>
                                        <td><?php echo e($umurBulan); ?> bln</td>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="<?php echo e(route('balita.show', $balita->id)); ?>" class="btn-action btn-view"
                                                    title="Lihat">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('balita.edit', $balita->id)); ?>" class="btn-action btn-edit"
                                                    title="Edit">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <a href="<?php echo e(route('balita.download', $balita->id)); ?>"
                                                    class="btn-action btn-download" target="_blank" title="Unduh">
                                                    <i class="fas fa-download"></i>
                                                </a>
                                                <form action="<?php echo e(route('balita.destroy', $balita->id)); ?>" method="POST"
                                                    style="margin:0;">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="btn-action btn-delete" title="Hapus"
                                                        onclick="return confirm('Yakin ingin menghapus data <?php echo e($balita->nama); ?>?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ITTP\YOI\posyandu - Salin\resources\views/kader/balita/index.blade.php ENDPATH**/ ?>