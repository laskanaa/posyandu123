...
<footer class="site-footer">
    ...
    <div class="footer-bottom">
        <p class="footer-bottom-copy">
            © <?php echo e(date('Y')); ?> <strong>Sistem Monitoring Posyandu Paguyangan</strong>. All Rights Reserved.
        </p>
        <div class="footer-bottom-badge">
            Dibuat dengan <span>♥</span> untuk masyarakat Paguyangan
        </div>
    </div>
</footer><?php /**PATH D:\ITTP\YOI\posyandu - Salin\resources\views/components/footer.blade.php ENDPATH**/ ?>