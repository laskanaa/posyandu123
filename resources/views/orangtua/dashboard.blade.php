    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dash-main {
            ...
            min-height: 100vh;
            /* Kunci: cegah konten melar keluar viewport */
            min-width: 0;
            overflow-x: hidden;
        }
        ...
        .topbar-page {
            ...
            /* Cegah judul mendorong elemen kanan keluar */
        ...
        .detail-table th {
            width: 160px; padding: 12px 20px;
            font-size: 11px; font-weight: 600; color: #7a9e9b;
        ...
        .scroll-hint {
            ...
            text-align: right; padding: 6px 16px 2px;
        }
        ...
        .table-wrapper {
            ...
            /* shadow kanan sebagai hint scroll */
            background:
        ...
        .riwayat-table td {
            ...
            color: #3d5a58; vertical-align: middle; white-space: nowrap;
        }
        .riwayat-table td:first-child { font-weight: 600; color: #7a9e9b; }

        /* Kolom pesan boleh wrap */
        td.col-pesan {
        ...
        /* Layar sangat sempit: detail table jadi vertikal */
