                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="{{ route('balita.show', $balita->id) }}" class="btn-action btn-view"
                                                    title="Lihat">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('balita.edit', $balita->id) }}" class="btn-action btn-edit"
                                                    title="Edit">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <a href="{{ route('balita.download', $balita->id) }}"
