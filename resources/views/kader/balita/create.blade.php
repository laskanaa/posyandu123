    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-back-top {
            ...
            color: var(--teal-dark); border-radius: 10px; text-decoration: none;
        ...
        .input-unit {
            ...
            font-size: 12px; font-weight: 600; color: #7a9e9b; pointer-events: none;
        }
        ...
        .btn-cancel {
            ...
            color: #7a9e9b; font-size: 14px; font-weight: 500;
            font-family: 'DM Sans', sans-serif; text-decoration: none; transition: all .25s;
        }
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-card-body">
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    <label>NIK</label>
                                    <input type="text" name="nik" placeholder="16 digit NIK" value="{{ old('nik') }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Tempat Lahir</label>
                                    <input type="text" name="tempat_lahir" placeholder="Kota / Desa" value="{{ old('tempat_lahir') }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_ibu" placeholder="Nama lengkap ibu" value="{{ old('nama_ibu') }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="berat_badan" placeholder="0.0" value="{{ old('berat_badan') }}" required oninput="formatAngka(this)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="tinggi_badan" placeholder="0.0" value="{{ old('tinggi_badan') }}" required oninput="formatAngka(this)">
                                ...
                                <div class="form-group">
                                    <label>LILA</label>
                                    <div class="input-wrapper">
                                        <input type="text" name="lila" placeholder="0.0" value="{{ old('lila') }}" required oninput="formatAngka(this)">
                                        <span class="input-unit">cm</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>LIKA</label>
                                    <div class="input-wrapper">
                                        <input type="text" name="lika" placeholder="0.0" value="{{ old('lika') }}" required oninput="formatAngka(this)">
                                        <span class="input-unit">cm</span>
                                    </div>
                                </div>
                            </div>
