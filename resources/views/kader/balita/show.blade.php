    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dash-main {
            ...
            flex-direction: column;
            min-height: 100vh;
            /* Kunci: batasi lebar agar tidak overflow */
            min-width: 0;
            overflow-x: hidden;
        }
        ...
        /* ─── RIWAYAT TABLE ─── */
        /* Wrapper dengan scroll horizontal + scroll-hint shadow */
        .table-wrapper {
            overflow-x: auto;
            -webkit-overflow-scrolling: touch;
            /* shadow kanan sebagai petunjuk scroll */
            background:
        ...
        .riwayat-table {
            ...
            /* Minimal lebar agar tabel tidak pecah, tapi bisa scroll */
            min-width: 800px;
        }
                ...
                <div class="panel">
                    ...
                    <table class="detail-table">
                        ...
                        <tr>
                            ...
                            <td>{{ $balita->tempat_lahir }}, {{ \Carbon\Carbon::parse($balita->tanggal_lahir)->format('d M Y') }}</td>
                        </tr>
                        <tr>
                            <th>Jenis Kelamin</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($p->hasil['status_bb']))
                                                <span class="status-badge {{ $stunt ? 'status-stunting' : 'status-normal' }}" style="font-size:11px;padding:3px 9px;">
                                                    {{ $p->hasil['status_bb'] }}
                                                </span>
                                            @else -
                                            @endif
                                        ...
                                        <td>
                                            <div class="action-cell">
                                                <a href="{{ route('penimbangan.edit', $p->id) }}" class="btn-icon btn-icon-edit" title="Edit">
