                ...
                <div class="info-grid">
                    ...
                    <div class="info-chip">
                        ...
                        <div class="info-chip-value">
                            {{ \Carbon\Carbon::parse($penimbangan->balita->tanggal_lahir)->format('d M Y') }}</div>
                    </div>
                    <div class="info-chip">
                        <div class="info-chip-label">Jenis Kelamin</div>
                        <div class="info-chip-value">
                            {{ $penimbangan->balita->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</div>
                    </div>
                </div>
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="berat_badan" value="{{ $penimbangan->berat_badan }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="tinggi_badan" value="{{ $penimbangan->tinggi_badan }}"
                                            required oninput="formatAngka(this)">
                                ...
                                <div class="form-group">
                                    <label>LILA</label>
                                    <div class="input-wrapper">
                                        <input type="text" name="lila" value="{{ $penimbangan->lila }}"
                                ...
                                <div class="form-group">
                                    <label>LIKA</label>
                                    <div class="input-wrapper">
                                        <input type="text" name="lika" value="{{ $penimbangan->lika }}"
                                            oninput="formatAngka(this)">
                                        <span class="input-unit">cm</span>
                                    </div>
                                </div>
                                <div class="form-group full">
                                    ...
                                    <textarea name="pesan"
                                        placeholder="Tuliskan catatan atau pesan untuk orang tua...">{{ old('pesan', $penimbangan->pesan) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
