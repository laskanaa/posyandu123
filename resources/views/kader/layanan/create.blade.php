                    ...
                    <form action="{{ route('kader.layanan.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select id="layananSelect" class="form-select" onchange="setLayananData()" required>
                                ...
                                <option value="Pemberian Vitamin A & Obat Cacing">💊 Pemberian Vitamin A & Obat Cacing
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="icon" name="icon" class="form-input" readonly
                                placeholder="Otomatis terisi saat memilih layanan">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Judul Layanan</label>
                            <input type="text" id="judul" name="judul" class="form-input" readonly
                                placeholder="Otomatis terisi saat memilih layanan">
                        </div>
