...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Amber accent bar for edit page */
    .form-card::before {
        content: '';
        position: absolute;
...
<div class="dash-wrapper">
    ...
    <div class="dash-main">
        ...
        <header class="dash-topbar">
            <div class="topbar-left">
                ...
                <div class="topbar-breadcrumb">
                    <span class="topbar-page">Edit Pencegahan</span>
                    <span class="topbar-sub">Pencegahan Stunting</span>
                </div>
            </div>
            <div class="topbar-right">
                <a href="{{ route('kader.pencegahan.index') }}" class="btn-back">
                    ← Kembali
                </a>
            </div>
        </header>
        ...
        <div class="dash-content">
            ...
            <h2 class="dash-section-title">Ubah Data Pencegahan</h2>

            <div class="form-card">

                <div class="edit-badge">
                    ✏️ Sedang mengedit data pencegahan
                </div>
                ...
                <form action="{{ route('kader.pencegahan.update', $pencegahan->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label class="form-label">Deskripsi Pencegahan <span>*</span></label>
                        <textarea
                            name="deskripsi"
                            class="form-textarea"
                            required>{{ old('deskripsi', $pencegahan->deskripsi) }}</textarea>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('kader.pencegahan.index') }}" class="btn-cancel">
                            Batal
                        </a>
                    </div>
                </form>
