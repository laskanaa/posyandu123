    ...
    <div class="dash-wrapper">
        ...
        <div class="dash-main">
            <header class="dash-topbar">
                <div class="topbar-left">
                    ...
                    <div class="topbar-breadcrumb">
                        <span class="topbar-page">Tambah Pencegahan</span>
            ...
            <div class="dash-content">
                ...
                <h2 class="dash-section-title">Tambah Data Pencegahan</h2>
                    ...
                    <form action="{{ route('kader.pencegahan.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" class="form-textarea" required
                                placeholder="Masukkan deskripsi pencegahan stunting...">{{ old('deskripsi') }}</textarea>
