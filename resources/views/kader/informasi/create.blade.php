...
@section('content')
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar-page {
            font-family: 'Playfair Display', serif;
            font-size: 20px; font-weight: 700; color: var(--teal-dark); line-height: 1.2;
        }
        ...
        /* Preview kartu informasi yang dipilih */
        .info-preview {
            display: none;
        ...
        .info-preview.show { display: flex; }
        ...
        .preview-icon {
            ...
            font-size: 22px;
            box-shadow: 0 2px 8px rgba(15,118,110,.1); flex-shrink: 0;
        }
        ...
        .preview-judul { font-size: 15px; font-weight: 600; color: var(--teal-dark); }
        ...
        .btn-save {
            ...
            transition: all .3s; box-shadow: 0 4px 14px rgba(15,118,110,.25);
            letter-spacing: .02em;
        }
    ...
    <div class="dash-wrapper">
        ...
        <div class="dash-main">
            ...
            <header class="dash-topbar">
                ...
                <a href="{{ route('kader.informasi.index') }}" class="btn-back">← Kembali</a>
            </header>
            ...
            <div class="dash-content">
                ...
                <div class="form-card">
                    ...
                    <form action="{{ route('kader.informasi.store') }}" method="POST" id="informasiForm">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="judul" id="judulSelect" class="form-select" required>
                                ...
                                <option value="Jumlah Balita"    {{ old('judul') == 'Jumlah Balita' ? 'selected' : '' }}>Jumlah Balita</option>
                                <option value="Balita Stunting"  {{ old('judul') == 'Balita Stunting' ? 'selected' : '' }}>Balita Stunting</option>
                                <option value="Jumlah Posyandu"  {{ old('judul') == 'Jumlah Posyandu' ? 'selected' : '' }}>Jumlah Posyandu</option>
                                <option value="Jumlah Kader"     {{ old('judul') == 'Jumlah Kader' ? 'selected' : '' }}>Jumlah Kader</option>
                            </select>
                        ...
                        {{-- Angka — tampil untuk semua kategori yang butuh angka --}}
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('kader.informasi.index') }}" class="btn-cancel">Batal</a>
                        </div>
                    </form>
                </div>
