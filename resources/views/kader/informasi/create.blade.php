                    ...
                    <form action="{{ route('kader.informasi.store') }}" method="POST" id="informasiForm">
                        ...
                        <div class="form-group">
                            ...
                            <select name="judul" id="judulSelect" class="form-select" required>
                                ...
                                <option value="Jumlah Balita" {{ old('judul') == 'Jumlah Balita' ? 'selected' : '' }}>Jumlah
                                    Balita</option>
                                <option value="Balita Stunting" {{ old('judul') == 'Balita Stunting' ? 'selected' : '' }}>
                                    Balita Stunting</option>
                                <option value="Jumlah Posyandu" {{ old('judul') == 'Jumlah Posyandu' ? 'selected' : '' }}>
                                    Jumlah Posyandu</option>
                                <option value="Jumlah Kader" {{ old('judul') == 'Jumlah Kader' ? 'selected' : '' }}>Jumlah
                                    Kader</option>
                            </select>
                        ...
                        <div class="angka-group" id="angkaGroup">
                            <div class="form-group" style="margin-bottom:0">
                                ...
                                <input type="number" name="angka" id="angkaInput" class="form-input" min="0"
                                    placeholder="Masukkan jumlah..." value="{{ old('angka') }}">
                                @error('angka')
                                    <span style="font-size:12px; color:#ef4444;">{{ $message }}</span>
                                @enderror
                            </div>
