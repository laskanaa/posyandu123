    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-label {
            ...
            color: #7a9e9b; letter-spacing: .05em;
        ...
        .file-input-wrapper input[type="file"] {
            padding: 10px 14px;
            border: 1.5px dashed rgba(15,118,110,.25);
            border-radius: 10px;
            background: #f8faf9;
            font-size: 13px;
            color: #3d5a58;
        ...
        <div class="dash-main">
            ...
            <header class="dash-topbar">
                <div class="topbar-left">
                    ...
                    <div>
                        <div class="topbar-page">Edit Slider</div>
                        <div class="topbar-sub">Perbarui konten slider</div>
                    </div>
                </div>
            ...
            <div class="dash-content">
                ...
                <h2 class="dash-section-title">Edit Data Slider</h2>

                <div class="panel">
                    <div class="panel-header">
                        <div class="panel-header-icon">🖼️</div>
                        <div class="panel-header-title">Form Edit Slider</div>
                    </div>
                    ...
                    <form action="{{ route('kader.slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="deskripsi" class="form-input"
                                    value="{{ old('deskripsi', $slider->deskripsi) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="preview-box">
                                    ...
                                    <img src="{{ asset('slider/' . $slider->gambar) }}"
                                        class="img-preview" alt="{{ $slider->judul }}"
                                        id="imgPreview">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Ganti Gambar <span style="color:#94a3b8;font-size:11px;text-transform:none;">(opsional)</span></label>
                        ...
                        <div class="form-footer">
                            <button type="submit" class="btn-save">
                                <i class="fas fa-floppy-disk"></i> Update Slider
                            </button>
