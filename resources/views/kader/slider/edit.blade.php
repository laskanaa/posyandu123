        ...
        <div class="dash-main">
            ...
            <div class="dash-content">
                ...
                <div class="panel">
                    ...
                    <form action="{{ route('kader.slider.update', $slider->id) }}" method="POST"
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-input"
                                    value="{{ old('judul', $slider->judul) }}" required placeholder="Masukkan judul slider">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="preview-box">
                                    ...
                                    <img src="{{ asset('slider/' . $slider->gambar) }}" class="img-preview"
                                        alt="{{ $slider->judul }}" id="imgPreview">
                                </div>
                            </div>
