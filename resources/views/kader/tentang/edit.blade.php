...
@section('content')
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi1" class="form-textarea" rows="6" required
                                    placeholder="Tuliskan deskripsi tentang posyandu...">{{ old('deskripsi1', $tentang->deskripsi1) }}</textarea>
                            </div>
                            ...
                            @if($tentang->gambar)
                                <div class="form-group">
                                    ...
                                    <div class="preview-box">
                                        ...
                                        <img src="{{ asset('tentang/' . $tentang->gambar) }}" class="img-current"
                                            id="imgPreview" alt="Gambar Tentang">
                                    </div>
                                </div>
                            @endif
    ...
    <script>
        (function () {
            ...
            const imgCurrent = document.getElementById('imgPreview');
            const previewWrap = document.getElementById('previewWrap');
            const imgNew = document.getElementById('imgPreviewNew');
