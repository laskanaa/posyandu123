        ...
        <div class="dash-main">
            <header class="dash-topbar">
                ...
                <div class="topbar-right">
                    ...
                    @if(!$tentang)
                        <a href="{{ route('kader.tentang.create') }}" class="btn-add-top">
                ...
                <div class="panel">
                    ...
                    @if($tentang)
                        <table class="detail-table">
                            <tr>
                                <th>Deskripsi</th>
                                <td style="white-space: pre-line; line-height: 1.6;">{{ $tentang->deskripsi1 }}</td>
                            </tr>
                            <tr>
                                <th>Gambar</th>
                                <td>
                                    @if($tentang->gambar)
                                        <img src="{{ asset('tentang/' . $tentang->gambar) }}" class="img-tentang"
                                            alt="Gambar Tentang">
                                    @else
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-cell">
                                        <a href="{{ route('kader.tentang.edit', $tentang->id) }}" class="btn-icon btn-icon-edit"
                                            title="Edit">
