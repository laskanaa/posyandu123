                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi1" class="form-textarea" rows="6"
                                    required placeholder="Tuliskan deskripsi tentang posyandu...">{{ old('deskripsi1') }}</textarea>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Upload Gambar <span style="color:#94a3b8;font-size:11px;text-transform:none;">(opsional)</span></label>
