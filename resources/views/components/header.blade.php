<header class="header">
    ...
    <div class="nav-container">
        ...
        <nav class="menu">
            ...
            <a href="#informasi" class="nav-btn">Informasi</a>
            <a href="#layanan" class="nav-btn">Layanan</a>
            <a href="#pencegahan" class="nav-btn">Pencegahan</a>
            <a href="#galeri" class="nav-btn">Galeri</a>
